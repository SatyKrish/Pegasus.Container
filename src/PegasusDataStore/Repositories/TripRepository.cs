...
namespace PegasusDataStore.Repositories
{
    public class TripRepository : ITripRepository
    {
        ...
        public async Task UpdateAsync(Trip trip)
        {
            ...
            var condition = new AccessCondition { Condition = trip.ETag, Type = AccessConditionType.IfMatch };

            try
            {
                await this._documentClient.ReplaceDocumentAsync(
                    UriFactory.CreateDocumentUri(DocumentDatabaseName, DocumentCollectionName, trip.Id),
                    trip,
            ...
            catch (DocumentClientException ex)
            {
                ...
                {
                    throw new DBConcurrencyException("Update operation failed.", ex);
                }
            }
        }
